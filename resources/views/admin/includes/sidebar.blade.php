    ...
    <div class="scroll-sidebar">
        ...
        <nav class="sidebar-nav">
            <ul id="sidebarnav">
                ...
                <li>
                    <a class="has-arrow waves-effect waves-dark"  aria-expanded="false">
                       <span class="hide-menu">Logo Section</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('logo.add')}}">Add LOGO</a></li>
                        <li><a href="{{route('logo.manage')}}">Manage LOGO </a></li>
                    </ul>
                </li>

                <li>
                    <a class="has-arrow waves-effect waves-dark"  aria-expanded="false">
                       <span class="hide-menu">Slider Section</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('slider.add')}}">Add Slider</a></li>
                        <li><a href="{{route('slider.manage')}}">Manage Slider </a></li>
                    </ul>
                </li>
                ...
                <li>
                    <a class="has-arrow waves-effect waves-dark"  aria-expanded="false">
                       <span class="hide-menu">Logo Slider</span>
                    </a>
                    <ul aria-expanded="false" class="collapse">
                        <li><a href="{{route('slider.add')}}">Add Slider</a></li>
                        <li><a href="{{route('slider.manage')}}">Manage Slider </a></li>
