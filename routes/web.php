...
Route::middleware(['auth:sanctum', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    Route::get('/logo-add',[DashBoardController::class,'addLogoMethod'])->name('logo.add');
    Route::post('/logo-stored',[DashBoardController::class,'storedLogoMethod'])->name('logo.stored');
    Route::get('/logo-manage',[DashBoardController::class,'manageLogoMethod'])->name('logo.manage');
    Route::get('/logo-edit{id}',[DashBoardController::class,'editLogoMethod'])->name('logo.edit');
    Route::post('/logo-update{id}',[DashBoardController::class,'updateLogoMethod'])->name('logo.update');
    Route::get('/logo-delete{id}',[DashBoardController::class,'deleteLogoMethod'])->name('logo.delete');

    Route::get('/slider-add',[DashBoardController::class,'addSliderMethod'])->name('slider.add');
    Route::post('/slider-stored',[DashBoardController::class,'storedSliderMethod'])->name('slider.stored');
    Route::get('/slider-manage',[DashBoardController::class,'manageSliderMethod'])->name('slider.manage');
    Route::get('/slider-edit{id}',[DashBoardController::class,'editSliderMethod'])->name('slider.edit');
    Route::post('/slider-update{id}',[DashBoardController::class,'updateSliderMethod'])->name('slider.update');
    Route::get('/slider-delete{id}',[DashBoardController::class,'deleteSliderMethod'])->name('slider.delete');
