...
class DashBoardController extends Controller
{
    ...
    public function addLogoMethod()
    {
        return view('admin.logo.add');
    }

    public function storedLogoMethod(Request $request)
    {
        Logo::storedLogo($request);
        return redirect()->back()->with('success', 'Logo Create SuccessFully');
    }

    public function manageLogoMethod()
    {
    ...
    public function editLogoMethod($id)
    {
        $this->logos = Logo::find($id);
        return view('admin.logo.edit',[
            'logos'=>$this->logos
        ]);
    }

    public function updateLogoMethod(Request $request, $id)
    {
        Logo::updateLogo($request, $id);
        return redirect()->route('logo.manage')->with('success', 'Logo Updated successfully.');
    }
    public function deleteLogoMethod($id)
    {
        Logo::deleteLogo($id);
    ...
    public function addSliderMethod()
    {
        return view('admin.slider.add');
    }

    public function storedSliderMethod(Request $request)
    {
        Slider::storedSlider($request);
    ...
    public function editSliderMethod($id)
    {
        $this->sliders = Slider::find($id);
        return view('admin.slider.edit',[
            'sliders'=>$this->sliders
        ]);
    }

    public function updateSliderMethod(Request $request, $id)
    {
